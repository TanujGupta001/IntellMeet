...
const getSessionSummary = asyncHandler(async (req, res) => {
  const session = await Session.findById(req.params.sessionId).populate("actionItems");
...
module.exports = { summarizeMeeting, getMeetingSummary, promoteActionItemToTask };